"""
ConvLSTM v4 for Headway Prediction

4-layer encoder-decoder with wider kernel (5,1) for larger receptive field.
Captures delay propagation across more stations.

Usage:
    from src.models.convlstmv4 import ConvLSTM
...
class ConvLSTM:
    """
    4-layer ConvLSTM encoder-decoder with (5,1) kernel.
    ...
    Kernel (5,1): Sees 5 stations along track per layer.
    After 4 layers: ~20 station effective receptive field.
