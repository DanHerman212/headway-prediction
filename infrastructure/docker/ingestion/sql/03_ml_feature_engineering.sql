...
*/
CREATE OR REPLACE TABLE `{{ params.project_id }}.mta_transformed.ml`
...
WITH target_origin AS (
  ...
  FROM `{{ params.project_id }}.mta_transformed.clean` target
  JOIN `{{ params.project_id }}.mta_transformed.clean` origin
